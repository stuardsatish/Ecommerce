...
            <li className="hover:text-error cursor-pointer transition min-h-[44px] flex items-center justify-center md:justify-start">Home</li>
            <li className="hover:text-error cursor-pointer transition min-h-[44px] flex items-center justify-center md:justify-start">Products</li>
            <li className="hover:text-error cursor-pointer transition min-h-[44px] flex items-center justify-center md:justify-start">Custom Cakes</li>
            <li className="hover:text-error cursor-pointer transition min-h-[44px] flex items-center justify-center md:justify-start">Contact Us</li>
          </ul>
        </div>
