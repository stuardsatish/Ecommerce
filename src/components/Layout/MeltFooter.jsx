...
const Footer = () => {
  ...
  return (
    <section
      ref={footerRef}
      className="inner-container bg-orange text-white mt-20"
    >
           {" "}
      <div className="pt-12 md:pt-24 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-0">
               {" "}
        <div className="text-3xl md:text-5xl font-semibold md:col-span-8">
          Crafted to melt,
          <br /> not rush.
        </div>
               {" "}
      ...
           {" "}
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 md:items-end mt-20 md:mt-40">
               {" "}
        ...
        <a href="" className="flex items-center gap-2 underline">
          ...
          >
                       {" "}
            <path
              d="M6.15467 25.3334C5.54044 25.3334 5.028 25.1281 4.61733 24.7174C4.20667 24.3067 4.00089 23.7939 4 23.1787V8.82141C4 8.20719 4.20578 7.69475 4.61733 7.28408C5.02889 6.87341 5.54089 6.66764 6.15333 6.66675H25.8467C26.46 6.66675 26.972 6.87253 27.3827 7.28408C27.7933 7.69564 27.9991 8.20808 28 8.82141V23.1801C28 23.7934 27.7942 24.3059 27.3827 24.7174C26.9711 25.129 26.4591 25.3343 25.8467 25.3334H6.15467ZM16 16.1547L26.6667 9.18008L26.256 8.00008L16 14.6667L5.744 8.00008L5.33333 9.18008L16 16.1547Z"
              fill="white"
            />
                     {" "}
          </svg>
      ...
           {" "}
      <div className="text-sm flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0 py-6 border-t border-[#ffffff50] mt-8 md:mt-12">
               {" "}
        <div>
          Design by <span className="underline">Rupz Web</span>
        </div>
               {" "}
