...
const MobileNav = () => {
  ...
  const wishlistCount = wishlistItems.length; // Close the dropdown when navigating, clicking outside, or pressing Escape.
  ...
  if (!isMobile) return null; // Dropdown items by role (paths are all existing routes).
