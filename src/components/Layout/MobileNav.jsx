...
            <div
              role="menu"
              className="absolute right-1 top-full mt-1 w-56 bg-white border border-black/10 rounded-xl overflow-hidden shadow-2xl z-[70]"
            >
...
                      className="w-full text-left px-4 py-3 text-sm text-black hover:bg-black/5 active:bg-black/5"
                    >
                      {item.label}
                    </button>
                  ))}
...
                    className="w-full text-left px-4 py-3 text-sm text-red-600 font-semibold hover:bg-red-50 active:bg-red-50 border-t border-black/5"
                  >
                    Logout
                  </button>
                </>
...
          const color = active ? "#A43B31" : "#44474C";
          return (
            <button
              key={path}
...
                  fill={fillActive && active ? "#A43B31" : "none"}
                />
                {dot && (
                  <span
                    style={{
