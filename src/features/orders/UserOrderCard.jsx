...
export default function UserOrderCard({
  ...
  return (
    <div
      className="order-card flex flex-col"
      style={{
        ...
        gap: "24px",
        boxShadow:
          "0px 1px 2px rgba(16,24,40,0.04), 0px 1px 3px rgba(16,24,40,0.08)",
      }}
    >
      <div
        className="flex"
        style={{ gap: "24px", alignItems: "stretch", width: "100%" }}
      >
        ...
        >
          ...
          >
            {m.icon === "truck" && (
              <Truck size={13} style={{ color: m.color }} />
            )}
            {m.icon === "check" && (
          ...
          <div
            className="flex flex-col"
            style={{ gap: "8px", width: "100%", marginTop: "16px" }}
          >
            {isDone && (
              <button
              ...
              >
                ...
                >
                  {m.key === "DELIVERED" ? "Buy Again" : "Reorder"}
                </span>
              </button>
            )}
            <button
