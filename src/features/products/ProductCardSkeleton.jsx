...
export const ProductCardSkeleton = () => {
  return (
    <div className="w-full h-full group">
      <div className="h-[340px] w-full bg-white relative flex flex-col rounded-2xl overflow-hidden shadow-sm border border-gray-100">
        ...
        <div className="p-3 flex flex-col flex-1 bg-white relative pt-5">
          {/* Price Label Placeholder */}
          <div className="absolute right-3 -top-5">
             <Skeleton className="w-16 h-7 rounded-full bg-neutral-300" />
          </div>
