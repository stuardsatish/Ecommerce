...
const MyProfile = () => {
  ...
  const currentUser =
    auth.currentUser; /* ── Live Firestore read (unsubscribe on unmount) ── */
  ...
  const showToast = (message) =>
    setToast({ show: true, message }); /* ── Derived display values ── */
  ...
  const memberSince = formatDate(
    currentUser?.metadata?.creationTime || profile.createdAt,
  );
  const addressObj =
  ...
  const handlePhotoUpload = async (e) => {
    ...
    const user = auth.currentUser;
    if (!file || !user) return;
    const _imgCheck = validateImageFile(file, {
  ...
  const desktopRow = (label, value) => (
    <div className="flex flex-col" style={{ gap: "4px" }}>
      ...
      <span style={{ fontSize: "14px", fontWeight: 600, color: C.textPri }}>
        {value || "—"}
      </span>
         {" "}
    </div>
  ...
  const copyBtn = (
    <button
      ...
      style={{ width: "28px", height: "28px", color: C.textSec }}
    >
  ...
  const changePwLink = (
    <button
      ...
      style={{ fontSize: "12px", fontWeight: 700, color: C.primary }}
    >
            Change    {" "}
    </button>
  ...
  const skeletonBlock = (style) => (
    <div
      ...
      style={{ background: C.inputBg, borderRadius: "8px", ...style }}
    />
    ...
    isMobile ? (
      <>
        ...
        <div
          ...
          style={{ padding: "24px 20px 16px", gap: "8px" }}
        >
                   {" "}
          {skeletonBlock({
            width: "80px",
        ...
        <div
          ...
          style={{ padding: "0 16px", gap: "16px" }}
        >
                    {skeletonCard(4)}          {skeletonCard(4)}         {" "}
          {skeletonCard(1)}       {" "}
        </div>
             {" "}
      </>
      ...
      <>
        ...
        >
          ...
          <div
            className="flex flex-col"
            style={{ gap: "10px", flex: 1, minWidth: 0 }}
          >
  ...
  const editModal = modalOpen && (
    ...
    >
      ...
      >
        ...
        >
                   {" "}
          <h2 style={{ fontSize: "18px", fontWeight: 700, color: C.textPri }}>
            Edit Profile
          </h2>
                   {" "}
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                background:
                  activeTab === t.key ? "var(--color-surface)" : "transparent",
                color: activeTab === t.key ? C.textPri : C.textSec,
                boxShadow:
                  activeTab === t.key ? "0px 1px 3px rgba(0,0,0,0.08)" : "none",
              }}
            >
                            {t.label}           {" "}
            </button>
        ...
        {activeTab === "personal" ? (
          <div className="flex flex-col" style={{ gap: "14px" }}>
            ...
                       {" "}
            <span style={{ ...kvLabel("11px"), marginTop: "4px" }}>
              Delivery Address
            </span>
                       {" "}
            <input
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, addressPincode: e.target.value })
              }
            />
                     {" "}
          </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setPwShow({ ...pwShow, [f.key]: !pwShow[f.key] })
                    }
                ...
                {pwErrors[f.key] && (
                  <span
                    style={{ fontSize: "12px", fontWeight: 500, color: C.red }}
                  >
                    {pwErrors[f.key]}
                  </span>
                )}
...
  ========================================================= */
  ...
  if (isMobile) {
    const sectionHeading = (title, withPencil) => (
      ...
      >
               {" "}
        <h3 style={{ fontSize: "14px", fontWeight: 600, color: C.textPri }}>
          {title}
        </h3>
               {" "}
        {withPencil && (
          <button onClick={() => openModal("personal")} aria-label="Edit">
        ...
        >
          ...
          {[
            ...
            return (
              <button
                key={n.label}
                onClick={() => !n.active && navigate(n.to)}
                className="flex flex-col items-center justify-center"
                style={{
                  gap: "4px",
                  color: n.active ? C.primary : "var(--color-body)",
                }}
              >
                                <Icon size={20} />               {" "}
