  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const res     = await fetch(`${API_BASE}/api/orders/manual-create`, {
        method: "POST",
        headers,
        body: JSON.stringify({ message, paymentStatus }),
      })
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={card}>
              ...
              <div style={{ display: "flex", gap: "12px" }}>
                {[
                  ...
                  { value: "pending", label: "Pending", icon: Clock,      color: "#B45309", bg: "#FEF3C7" },
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                ...
                style={{
                  flex: 1,
                  height: "52px",
                  background: loading || !hasContent ? "#ccc" : C.brand,
                  color: C.white,
                  border: "none",
                  borderRadius: "12px",
                  fontFamily: MANROPE,
                  ...
                  boxShadow: loading || !hasContent ? "none" : `0 4px 16px ${C.brand}40`,
                }}
              >
                {loading
            ...
            {result && (
              <div style={{
                ...
                border: `1.5px solid ${result.success ? "#86EFAC" : "#FFBDAD"}`,
                display: "flex",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", position: "sticky", top: "104px" }}>
                  ...
                  {[
                    ...
                    <div key={lbl} style={{ display: "flex", alignItems: "flex-start", gap: "10px" }}>
                      <div style={{
                        ...
                        background: `${C.brand}12`, display: "flex", alignItems: "center",
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px", paddingTop: "4px" }}>
                    {paymentStatus === "paid"
                      ...
                      : <><Clock      size={14} color="#B45309" /><span style={{ fontSize: "12px", color: "#B45309", fontWeight: 600 }}>Will be marked Pending</span></>
                    }
                  </div>
                </div>
              ) : (
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: "13px", color: C.blueText, lineHeight: "1.6" }}>
                <strong>ℹ What happens on submit:</strong><br />
