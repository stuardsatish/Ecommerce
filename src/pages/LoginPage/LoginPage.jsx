...
      broadcastAuth("login", { role: profile.role, userId: data.user.id });
      toast.success("Welcome back ");
      if (profile.role === "admin") navigate("/admin/myorders");
      else navigate("/");
    } catch (error) {
...
                }}
              >
                Sent a password reset link to <strong>{resetEmail}</strong> if
